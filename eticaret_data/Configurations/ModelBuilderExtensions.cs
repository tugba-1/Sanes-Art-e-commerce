...
//            builder.Entity<Category>().HasData(new Category() { Id = 1, Name = "Yağlı Boyalar" },
...
//            );
//            builder.Entity<ProductCategory>().HasData(new ProductCategory() { ProductId = 2, CategoryId = 2 },
