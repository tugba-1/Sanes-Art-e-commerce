...
namespace eticaret_v2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public UserManager<Identity.Users> _userManager;
        public CommentManager commentmanager;
        public HomeController(ProductManager _productmanager, CardManager cardManager, UserManager<Identity.Users> userManager, CommentManager _commentmanager)
        {
